% Xiaodong Zhang
% 20210414
% 1. Add SN 1425 (copied from lisstvsf_getcal_1425.m)
% 2. Notice difference in calfact.geometric_cal_coeff between 1662 and 1425
% 20210621
% 1. Add SN 1664 (copied from lisstvsf_getcal_1664.m)
...
switch SN  
    case 1662
        ...
        calfact.angle_offset = 6;
        calfact.Watt_per_count_on_rings = 1.9e-10; 
        calfact.Watt_per_count_laser_ref = 4.577e-6 .* 1.04; % multiplied by 1.04 for Fresnel loss
        calfact.ND = 10.23; 
        calfact.laser_power_change_factor = 12;
        calfact.HWPlate_transmission = 0.71;
